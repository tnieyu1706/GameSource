...
{
    [Serializable]
    public class OrderPubTableState : PubTableState, IInputGameplayHandler, IStateUIInteraction
    {
        ...
        public OrderPubTableState(IPubTableContext context, Action onUIInitialized, Action<float> onUIUpdated,
        ...
        void AcceptOrder()
        {
            ...
            Context.CurrentState = Context.PubTableStateHolder.waitingState;
            this.Exit();
            Context.CurrentState.Entry();
        }
    }
