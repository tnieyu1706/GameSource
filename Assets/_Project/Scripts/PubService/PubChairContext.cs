...
{
    public interface IPubChairContext : IBaseTypeData
    {
        PubChairState CurrentState { get; set; }
        ...
        PubChairStateHolder PubChairStateHolder { get; }

        void ChangeState(PubChairState state);
    }
    ...
    [Serializable]
    public class PubChairStateHolder
    {
        public IdlePubChairState idleState;
        public OrderPubChairState orderState;
        public WaitingPubChairState waitingState;
        public ClearPubChairState clearState;

        private PubChairStateHolder()
        {
        }

        public class Builder : IMyBuilder<PubChairStateHolder>
        {
            private PubChairStateHolder holder;
            private PubChairContext context;

            public Builder(PubChairContext context)
            {
                this.context = context;
                holder = new PubChairStateHolder();
            }

            public Builder BuildIdleState()
            {
                holder.idleState = new IdlePubChairState(context);
                return this;
            }
            ...
            {
                holder.orderState = new OrderPubChairState(context, onUIInit, onUIUpdate, onUIClose);
                return this;
            }
            ...
            {
                holder.waitingState = new WaitingPubChairState(context, onUIInit, onUIUpdate, onUIClose);
                return this;
            }

            public Builder BuildClearState(Image clearIcon)
            {
                holder.clearState = new ClearPubChairState(context, clearIcon);
                return this;
            }

            public PubChairStateHolder Build()
            {
                return holder;
            }
        }
    ...
    public class PubChairContext : MonoBehaviour, IPubChairContext, IItemInteractable,
        IUnsubscribeInteractable<IItemUser>
    {
        ...
        private PubChairState currentState;
        ...
        public PubChairState CurrentState
        {
            get => currentState;
        ...
        public PubChairStateHolder PubChairStateHolder
        {
            get => holder;
            set => holder = value;
        }
        ...
        void Awake()
        {
            ...
            PubChairStateHolder =
                new PubChairStateHolder.Builder(this)
                    .BuildIdleState()
                    .BuildOrderState(
                        OnOrderStateUIInit,
        ...
        public void ChangeState(PubChairState state)
        {
        ...
        void Start()
        {
            CurrentState = PubChairStateHolder.idleState;
            CurrentState.Entry();
        }
