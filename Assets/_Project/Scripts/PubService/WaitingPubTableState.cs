...
{
    [Serializable]
    public class WaitingPubTableState : PubTableState, IInputGameplayHandler, IStateUIInteraction
    {
        ...
        public WaitingPubTableState(
            IPubTableContext context,
        ...
        {
            Context.CurrentState = Context.PubTableStateHolder.clearState;
            this.Exit();
            Context.CurrentState.Entry();
            yield return null;
        }
