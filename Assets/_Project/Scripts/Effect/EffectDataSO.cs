...
{
    [CreateAssetMenu(fileName = "New Effect Data", menuName = "Scriptable Objects/EffectSystem/EffectDataSO")]
    public class EffectDataSO : SerializedScriptableObject, IEffectData
    {
